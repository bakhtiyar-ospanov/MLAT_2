...
// using UnityEngine;
//
// namespace Modules.MechanicumCourse
// {
//     public class MCourseReport
//     {
//         public IEnumerator CreateReport(MCourseModel.ReportInfo reportInfo)
//         {
...
//             var score = Math.Round(100.0f*(4 * questions.Count - mistakesSum) 
//                                    / (4 * questions.Count) , 1);
