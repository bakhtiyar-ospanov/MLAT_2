...
{
    public class Ophthalmoscope : Carriable
    {
        private bool isBlocked;
        private List<string> contactPoints 
            = new List<string> {"EyeL"};
        private string checkUpId = "7761";
        ...
        private void CustomAction()
        {
            ...
            if (XRSettings.enabled)
            {
                ...
                assetTrans.localPosition = new Vector3(0.0245999992f,-0.0138999997f,0.000300000014f);
                assetTrans.localEulerAngles = new Vector3(353.86142f,125.194473f,16.6370754f);
            }
            else
            {
