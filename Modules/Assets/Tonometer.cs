...
{
    public class Tonometer : Carriable
    {
        private bool isBlocked;
        private List<string> contactPoints 
            = new List<string> {"BrachialArteryR", "BrachialArteryL"};
        private string checkUpId = "6189";
        ...
        private void CustomAction()
        {
            ...
            if (XRSettings.enabled)
            {
                ...
                assetTrans.localPosition = new Vector3(-0.00700000022f, 0.0518000014f, 0.0916000009f);
                assetTrans.localEulerAngles = new Vector3(315.824158f,171.856598f,44.1994438f);
            }
            else
            {
