...
{
    public class Glucometer : Carriable
    {
        private bool isBlocked;
        private List<string> contactPoints 
            = new List<string> {"ForefingerL", "ForefingerR"};
        private string checkUpId = "3856";
        ...
        private void CustomAction()
        {
            ...
            if (XRSettings.enabled)
            {
                ...
                assetTrans.localPosition = new Vector3(0.0105999997f,0.0228000004f,0.0252999999f);
                assetTrans.localEulerAngles = new Vector3(53.6609802f, 199.42984f, 67.6375732f);
            }
            else
            {
                ...
                assetTrans.localEulerAngles = new Vector3(45.0f, 180.0f, 0.0f);
            }
            isBlocked = false;
        }
        ...
        private void AddToDiseaseHistory()
        {
            ...
            foreach (var checkUp in rootResearch.children)
            {
                ...
                GameManager.Instance.labSelectorController.passedAnswers.Add(checkUpId);
                GameManager.Instance.diseaseHistoryController.AddNewLabValue(Config.LabResearchParentId, checkUp.GetInfo());
